...
const Sidebar = () => {
  ...
  const activeStyle = {
    borderLeft: '3px solid #9C0F94',
    borderRight: '3px solid #9C0F94',
    width: '100%',
    padding: '20px'
  };
  ...
  return (
    <div className='bg-secondary w-[20%]  p-8 py-4 h-[100vh] hidden lg:flex flex-col md:flex'>
      ...
      <button className="text-[18px] text-primary  font-[700] flex items-center py-4 px-6  hover:text-[#015C28]" onClick={() => disconnect()}><TbSettings className="mr-4 text-[18px]"  /> Log out</button>
      </div>
    </div>
  );
}
